...
int main()
{
	...
	//Test number_completions
	test(words.number_completions("ba") == 3470);
	test(words.number_completions("squir") == 21);
	test(words.number_completions("char") == 285);
	test(words.number_completions("barb") == 101);
	test(words.number_completions("w") == 10226);
