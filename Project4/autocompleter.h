...
public:
	...
	// Return the number of completiosn for word x.
...
private:
	...
	// An optional helper method you might want to implement
	// that computes and returns the number of strings stored in
	// the sub-tree rooted at node p.
	int size(Node* p);
};
